...
const getOptionsManifestForSection = sectionId => new ManifestProvider().getOptionsManifest(sectionId);

const updateSections = (sections) => {
  const updatedSections = Object.entries(sections).reduce((section, [sectionKey, sectionValue]) => {
