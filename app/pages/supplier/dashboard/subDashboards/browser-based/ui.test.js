...
test('should render all the sections for the browser-based sections section group', async (t) => {
  ...
  await t
    ...
    .eql('browser-based/section/browser-browsers-supported')
    ...
    .eql('browser-based/section/browser-mobile-first')
    ...
    .eql('browser-based/section/browser-plug-ins-or-extensions')
    ...
    .eql('browser-based/section/browser-connectivity-and-resolution')
    ...
    .eql('browser-based/section/browser-hardware-requirements')
    ...
    .eql('browser-based/section/browser-additional-information')
